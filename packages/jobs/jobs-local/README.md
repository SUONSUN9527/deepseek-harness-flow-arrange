...
- **Process-local execution is still not durable** — a timeout can classify work as `orphaned`, but cannot recover or terminate a process that no longer responds to its producer hooks.
